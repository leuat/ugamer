...
public class ComboBox : MonoBehaviour 
{
	...
	public Color color;
	public Color normalColor, highlitedColor, scrollbarColor, pressedColor, textColor;
	public Font font;
	...
	public bool Interactable
	{
		...
		set
		{
			...
			image.color = image.sprite == null ? color : _interactable ? button.colors.normalColor : button.colors.disabledColor;
	...
	public void CreateControl()
	{
		...
		comboButtonColors.normalColor = normalColor;
		comboButtonColors.highlightedColor = highlitedColor;
		comboButtonColors.pressedColor = pressedColor;
		...
		comboArrowText.color = textColor;
		comboArrowText.alignment = TextAnchor.MiddleCenter;
		comboArrowText.font = font;
		comboArrowText.text = "▼";
	...
	public void InitControl()
	{
		...
		scrollbarColors.normalColor = scrollbarColor;
		scrollbarColors.highlightedColor = scrollbarColor;
		scrollbarColors.pressedColor = scrollbarColor;
		scrollbarColors.disabledColor = scrollbarColor;
